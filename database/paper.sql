...
CREATE TABLE IF NOT EXISTS `chapter` (
  ...
  `chaptername` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `course` (
  ...
  `manager` varchar(50) COLLATE utf8_bin NOT NULL,
  `gmt_create` datetime DEFAULT NULL,
...
-- 正在导出表  paper.course 的数据：~12 rows (大约)
...
CREATE TABLE IF NOT EXISTS `paper` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `papername` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `paperconfig` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `chaptercover` int(11) DEFAULT '80',
  `sectioncover` int(11) DEFAULT '100',
  `qestypecount` int(11) DEFAULT '5',
  `prevdup` int(11) DEFAULT '30',
  `sibdup` int(11) DEFAULT '10',
  `gmt_create` datetime DEFAULT NULL,
  `gmt_modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `question` (
  ...
  `questiontypeid` varchar(20) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `question` (`id`, `sectionid`, `question`, `questiontypeid`, `answer`, `username`, `isdeleted`, `gmt_create`, `gmt_modified`) VALUES
	(23, 11, '下列关于C语言的说法错误的是(  )。\r\nA、 C程序的工作过程是编辑、编译、链接、执行。 \r\nB、 C语言不区分大小写。 \r\nC、 C程序的三种基本结构是顺序、选择、循环。 \r\nD、 C程序从main函数开始执行。', '单选题', 'B', 'Wt', 0, NULL, NULL),
	(24, 13, '2、 C语言源程序名的后缀是(  ) 。 \r\nA、 .exe\r\nB、 .c\r\nC、 .obj\r\nD、 .cpp', '单选题', 'B', 'Wt', 0, NULL, NULL),
	(25, 13, '一个C语言程序总是从______ 开始执行。', '填空题', '主函数;main函数;', 'Wt', 0, NULL, NULL),
	(26, 12, 'C语言是一种结构化程序设计语言,而结构化程序设计的基本结构有3种,分别是             ________、_______和________。', '填空题', '顺序；分支;选择；循环；', 'Wt', 0, NULL, NULL),
	(27, 13, 'C语言源程序经过编译后,生成扩展名为__________的目标文件;经过链接后,生成扩展名为__________的可执行文件。', '填空题', '.obj ；.exe；', 'Wt', 0, NULL, NULL),
	(28, 14, '一个完整的C语言程序,是由一个__________和若干(或0个)其它函数结合而成的。', '填空题', '主函数；', 'Wt', 0, NULL, NULL),
	(29, 12, 'C语言是一种具有某些低级语言特征的高级语言。(   )', '判断题', '正确', 'Wt', 0, NULL, NULL),
	(30, 12, 'C语言程序的实现与其它高级语言一样也需要经过编辑、编译、链接和执行的步骤。', '判断题', '正确', 'Wt', 0, NULL, NULL),
	(31, 14, '预处理指令的前面必须加一个“#”号。', '判断题', '正确', 'Wt', 0, NULL, NULL),
	(32, 13, '下列四组选项中,正确的C语言标识符是(  )。\r\nA、 %x \r\nB、 a+b\r\nC、 a123\r\nD、 123', '单选题', 'C', 'Wt', 0, NULL, NULL),
	...
	(38, 13, 'C语言中的标识符只能由________、_______和_______组成。开头必须是______或             _______。', '填空题', '数字；字母；下划线；字母；下划线；', 'Wt', 0, NULL, NULL),
	(39, 13, '一般地,调用标准字符或格式输入输出库函数时,文件开头应有以下预编译指令_________。', '填空题', '#include<stdio.h>；', 'Wt', 0, NULL, NULL),
	...
	(43, 13, 'C语言程序在书写上只能是一条语句写一行。', '判断题', '错误', 'Wt', 0, NULL, NULL),
	...
	(48, 13, 'C语言程序中可以有多个函数,但只能有一个主函数。', '判断题', '正确', 'Wt', 0, NULL, NULL),
	...
	(165, 13, '什么叫做可见性？可见性的一般规则是什么？', '应用题', '', 'Wt', 0, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `questiontype` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `questiontypename` varchar(20) COLLATE utf8_bin NOT NULL,
  `gmt_create` datetime DEFAULT NULL,
  `gmt_modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `section` (
  ...
  `sectionname` varchar(50) COLLATE utf8_bin NOT NULL,
...
-- 正在导出表  paper.section 的数据：~103 rows (大约)
/*!40000 ALTER TABLE `section` DISABLE KEYS */;
INSERT INTO `section` (`id`, `chapterid`, `sectionname`, `number`, `gmt_create`, `gmt_modified`) VALUES	(11, 11, '程序设计语言', 1, NULL, NULL),
	(12, 11, 'C语言的发展', 2, NULL, NULL),
	(13, 11, 'C程序初识', 3, NULL, NULL),
	(14, 11, '简单的C语言程序', 4, NULL, NULL),
	(15, 11, '简单的', 4, NULL, NULL),
	(16, 11, '简单的', 4, NULL, NULL),
	(17, 12, '如何将数据存入计算机', 1, NULL, NULL),
	(18, 12, '如何将数据存入计算机', 1, NULL, NULL),
	(19, 12, '其他数据表示', 2, NULL, NULL),
	(20, 12, '数据的输入与输出', 3, NULL, NULL),
	(21, 12, '数据的运算', 4, NULL, NULL),
...
-- 正在导出表  paper.teacher 的数据：~1 rows (大约)
/*!40000 ALTER TABLE `teacher` DISABLE KEYS */;
INSERT INTO `teacher` (`id`, `name`, `username`, `password`, `email`, `gmt_create`, `gmt_modified`) VALUES
	(1, '温吞', 'Wt', '123456', '2785462920', '2020-11-08 10:02:21', '2020-11-08 10:52:56'),
(2,'admin','admin','123456','2785462920','2020-11-08 10:02:21', '2020-11-08 10:52:56');
