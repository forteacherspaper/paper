				...
				<table width="100%" border="0" align="center">
					...
					<tr valign="middle">
		                <td align="center" colspan="7">
							<a href="delete.php?ID=<?php echo $row_teacher['id'] ?>" title="delete.php?ID=<?php echo $row_teacher['id'] ?>"><h3>删除</h3></a>
							<a href="editteacher.php?ID=<?php echo $row_teacher['id'] ?>" title="editteacher.php?ID=<?php echo $row_teacher['id'] ?>"><h3>编辑</h3></a>
						</td>
					</tr>
	            </table>
			</td>
